...
function benchmarkDomanda(){
if(Contatore >= 10){
  alert("quiz finished! score: " + score + " on 10 ");
...
let Counter = document.querySelector(".domandecounter")

let randomIndex
*/
do{
  randomIndex = Math.floor(Math.random() * questions.length)
}while (usedDomande.includes(randomIndex))
  usedDomande.push(randomIndex)
  ...
  function checkeAnswer(userSelAnswer){
    if(userSelAnswer=== currentDomanda.currect_answer){
      score++
    }
    benchmarkDomanda()
  }
